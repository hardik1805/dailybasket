            ...
            <div className="container-lg">
                <div className="row">
                    ...
                    {tab === 3 && <div className="col-md-10">
                        ...
                        <div className="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-4">
                            {products.map((item) => <div key={item.name} className="wishlist-card col">
                                <button type="button" className="btn-close"></button>
