            ...
            <div className="container-lg">
                <div className="row g-5">
                    ...
                    <div className="col-md-7 col-lg-8">
                        <BillingAddress state={state} onHandleChange={onHandleChange} validator={validator} setAddress={setAddress} />
                        <PaymentInfo state={state} onHandleChange={onHandleChange} validator={validator} updateDetails={updateDetails} />
                    </div>
                </div>
            </div>
        </section>
