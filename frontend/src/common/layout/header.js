                        ...
                        <li className="nav-item border-dashed">
                            ...
                            <div className="collapse" id="beverages-collapse">
                                <ul className="btn-toggle-nav list-unstyled fw-normal ps-5 pb-1">
                                    <li className="border-bottom py-2"><Link to="/category" className="dropdown-item">Water</Link></li>
                                    <li className="border-bottom py-2"><Link to="/category" className="dropdown-item">Juice</Link></li>
                                    <li className="border-bottom py-2"><Link to="/category" className="dropdown-item">Soda</Link></li>
                                    <li className="border-bottom py-2"><Link to="/category" className="dropdown-item">Tea</Link></li>
                                </ul>
                            </div>
                        </li>
                        <li className="nav-item border-dashed">
